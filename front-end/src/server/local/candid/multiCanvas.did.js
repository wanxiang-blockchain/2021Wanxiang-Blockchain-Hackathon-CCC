export const idlFactory = ({ IDL }) => {
  ...
  const MultiCanvas = IDL.Service({
    ...
    'getAccInfo2' : IDL.Func([IDL.Principal], [MultiCanvasAccInfo], ['query']),
    ...
    'getAllIncome' : IDL.Func([], [IDL.Nat], ['query']),
    ...
    'setPixelNum' : IDL.Func([IDL.Nat, IDL.Principal], [IDL.Bool], []),
